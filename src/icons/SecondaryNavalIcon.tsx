...
interface SecondaryAirIconProps {
  x: number;
  y: number;
  size?: number;
  color?: string;
...
const SecondaryAirIcon: React.FC<SecondaryAirIconProps> = ({
  x,
  y,
  size = 64,
  color = '#ffff00', // 黄色
  ...
  // 梯形左侧平行线（起点为梯形上长边1/3处，方向与对钩长边平行，长度略短于对钩长边）
...
export default SecondaryAirIcon; 